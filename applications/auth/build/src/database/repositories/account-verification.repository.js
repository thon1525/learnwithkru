...
const account_verification_model_1 = __importDefault(require("../models/account-verification.model"));
class AccountVerificationRepository {
    ...
    DeleteAccountVerifyByAuthId(_a) {
        return __awaiter(this, arguments, void 0, function* ({ authId }) {
            return yield account_verification_model_1.default.deleteOne({ authId });
        });
    }
    DeleteVerificationByToken(_a) {
        return __awaiter(this, arguments, void 0, function* ({ token }) {
            try {
