...
describe('Email Consumer', () => {
    ...
    describe('consumeAuthEmailMessage', () => {
        it('should be called ', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const connectionChannel = yield connection.createQueueConnection();
            yield (0, email_consumer_1.consumeAuthEmailMessages)(connectionChannel);
            expect(connectionChannel.assertExchange).toHaveBeenCalledWith('microsample-email-notification', 'direct');
            expect(connectionChannel.assertQueue).toHaveBeenCalledTimes(1);
            expect(connectionChannel.bindQueue).toHaveBeenCalledWith('auth-email-queue', 'microsample-email-notification', 'auth-email');
        }));
    });
});
