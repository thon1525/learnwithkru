...
console.log("user",token)
  ...
  useEffect(() => {
    if (error.toLocaleLowerCase().trim() === 'User is already verified'.toLowerCase().trim()) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-5 bg-gray-200 min-w-screen">
      <div className="max-w-xl p-8 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
        <h3 className="text-2xl">Please check your Email for verifying with Learnwithkru.com!</h3>
        ...
        <div className="mt-4">
          ...
          <button className="px-2 py-2 text-blue-200 bg-blue-600 rounded" onClick={handleOnSubmit}>
