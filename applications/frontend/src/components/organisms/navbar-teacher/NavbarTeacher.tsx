...
const NavbarTeachers: React.FC<NavbarProps> = ({
  className,
  teacher,
  isTeachers,
}) => {
          ...
          <ul className="mx-5 w-full">
            {isTeachers ? (
              <>
                ...
                ></li>
                <Typography className="w-full mt-10 self-center">
                  <button className="w-full text-sm text-red-600 hover:bg-red-200 hover:p-1 hover:rounded-md">
                    Logout
                  </button>
                </Typography>
